...
function iniciarApp() {
    ...
    seleccionarFecha(); //Agrega una fecha en el objeto
    seleccionarHora(); //Agrega una hora en el objeto
...
async function consultarAPI() {
    ...
    function seleccionarServicio(servicio) {
        ...
        //Identificar cual es el elemento que se le da Click
    ...
    function mostrarAlertas(mensaje, tipo, elemento, desaparece = true) {
        ...
        if(desaparece) {
            //Eliminar alerta depues del tiempo indicado
        setTimeout(() => {
            alerta.remove();
        },3000);
        }
  ...
  async  function reservarCita() {
        ...
        const idSercios = servicios.map ( servicio => servicio.id );
        ...
        datos.append('servicios', idSercios);
